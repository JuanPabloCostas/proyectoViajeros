    ...
    return (
        <nav className='bg-[#25639D] h-24 w-screen flex items-center justify-between px-4'>
            ...
            <div className='flex items-center justify-center gap-x-4 text-white'>
                <button className='text-4xl font-bold' onClick={() => onButtonClick('Registrar Alumno')}>
                Registrar Alumno
                </button>
                <div className='w-1 h-16 border-l border-dotted border-white'></div>
                <button className='text-4xl font-bold' onClick={() => onButtonClick('Checar Solicitudes')}>
                Checar Solicitudes
                </button>
            </div>
        </nav>
